 ...
 * - 완료 후 split_38의 A1 + B/D/E/G/H열 2행 이하 초기화
 *************************************************/
...
function append_split38_to_DataDS() {
  ...
  const rawValues = src.getRange(2, 6, 38, 3).getValues();
  ...
  SpreadsheetApp.getUi().alert(
    ...
    `split_38 시트의 A1 및 B/D/E/G/H열을 초기화했습니다.`
  );
}